...
gheatmap = gmplot.GoogleMapPlotter(center_lat, center_lon, 12, apikey=api_key)  # New gmplot object for heatmap

# Make heatmap:
gheatmap.heatmap(latitudes, longitudes, radius=20)

# Define output path for the heatmap
output_dir = "map_outputs"
heatmap_output_path = os.path.join(output_dir, "nyccrashes_heatmap.html")

# Save the heatmap
gheatmap.draw(heatmap_output_path)
```
