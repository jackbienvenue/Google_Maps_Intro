...
Like a password to access your creation
...
10. Map management
    ...
    - VECTOR
11. Create Style
    - Apply style by returning to Map Management
12. Create directory
    - index.html
        -! Emmet shortcut to add boilerplate html
        - Retitle (line 6)
        - add link tag for style.css under title line
            - <link rel="stylesheet" href = "style.css">
        - add js reference
            - Idented <script src="script.js"></script> between <body> tags on lines 9 and 11
    - style.css
    - script.jb

    mkdir map_files
    cd map_files
    touch index.html style.css script.js  # macOS/Linux

13. I got live server extension
    -> Hit go live bottom right of VSCode
